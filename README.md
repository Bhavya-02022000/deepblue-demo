...
Here I am working on Face recognition based Temperature Monitoring System by using OpenCV(Python). This system is required to contactlessly measure the temperature of different users by just recognizing their face
